...
Le prochain fichier sera créé à l'étape 10 (fonctions d'administration) ou à l'étape 11 (compte administrateur).
...
(visiteur, employé, employé désactivé, administrateur). **376 tests** au 19 septembre 2026.
