...
| `10-nettoyage-comptes-zztest.sql` | Supprime les comptes d'essai « ZZTEST » (nom ET numéro 819 555 019x) et tout ce qu'ils ont produit ; refuse si des données de vrais comptes sont mêlées. À réexécuter après chaque série d'essais réels | **écrit et testé, PAS encore exécuté** |
...
(visiteur, employé, employé désactivé, administrateur). **645 tests** au 19 septembre 2026.
