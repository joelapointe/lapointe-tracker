...
| Dossier | Rôle | État |
|---|---|---|
| `functions/admin-employes/` | Créer, désactiver, réactiver, supprimer un employé ; réinitialiser un NIP (administrateur seulement) | déployée le 19 septembre 2026 (2e version, avec création du profil par le serveur) ; essayée sur la vraie base avec le compte administrateur : 80/80 (étape 11). Mode d'emploi dans son README |
...
(visiteur, employé, employé désactivé, administrateur). **743 tests** au 19 septembre 2026.
