// Étape 19 (morceau 4) — Fichier SQL 23 : la table types_service (les types de service deviennent modifiables par l'administrateur).
...
// SQL23_TEST (variable d'environnement) : une COPIE abîmée du fichier 23, pour les « erreurs volontaires » ; le vrai fichier n'est jamais touché.
